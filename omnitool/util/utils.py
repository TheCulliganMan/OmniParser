...
from omnitool.util.box_annotator import BoxAnnotator
...
def annotate(
    ...
    label_coordinates = {
        f"{phrase}": v for phrase, v in zip(phrases, xywh, strict=False)
    }
...
def get_som_labeled_img(
    ...
    ocr_bbox_elem = [
        ...
        for box, txt in zip(ocr_bbox, ocr_text, strict=False)
